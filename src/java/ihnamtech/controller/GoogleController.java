...
import static ihnamtech.utils.Google.getToken;
import static ihnamtech.utils.Google.getUser;
import ihnamtech.dto.GoogleDTO;
import ihnamtech.dto.UserDTO;
import ihnamtech.utils.Google;
...
public class GoogleController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check = dao.loginWithGoogle(gdto);

            if (check) {
                UserDTO dto = dao.getUserInformation(gdto.getId());
